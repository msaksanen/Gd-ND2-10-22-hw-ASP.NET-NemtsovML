...
namespace MedContactApp.MappingProfiles
{
    public class AppointmentProfile : Profile
    {
        public AppointmentProfile()
        {
            ...
            CreateMap<(Appointment, DoctorData, CustomerData), AppointmentInfo>()
          .ForMember(i => i.Id, opt => opt.MapFrom(d => d.Item1.Id))
               ...
               .ForMember(i => i.DoctorEmail, d => d.MapFrom(dt => (dt.Item2.User != null) ? (dt.Item2.User.Email ?? String.Empty) : String.Empty))
               ...
               .ForMember(i => i.CustomerEmail, d => d.MapFrom(dt => (dt.Item3.User != null) ? (dt.Item3.User.Email ?? String.Empty) : String.Empty))

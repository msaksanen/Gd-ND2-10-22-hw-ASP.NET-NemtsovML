...
{
    public static class OldPaginatorHelper
    {
        public static HtmlString GenerateOldPaginator(this IHtmlHelper html, int pageCount, int currentPage, string pageRoute)
        {
